...
describe('Pokemon model', () => {
    ...
    describe('Pokedex number', () => {
        ...
        it.skip('number must be above 1', () => {
            const pokemon = new Pokemon({
                name: 'Pikachu',
                type: 'Electric',
                pokedexNumber: 0
        ...
        it.skip('number must be below 151 (cause we only doing the original 151 bitches!!!', () => {
            const pokemon = new Pokemon({
                name: 'Pikachu',
                type: 'Electric',
                pokedexNumber: 152
