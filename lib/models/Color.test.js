...
describe('Color model', () => {
    ...
    describe('red', () => {
        it.skip('has a required red value', () =>{
            const color = new Color({
                name: 'red',
                green: 0,
                blue: 0
        ...
        it.skip('has a required red value above 0', () => {
            const color = new Color({
                name: 'red',
                red: -1,
                green: 0,
        ...
        it.skip('has a required red value under 256', () => {
            const color = new Color({
                name: 'red',
                red: 256,
                green: 0,
    ...
    describe('blue', () => {
        it.skip('has a required blue value', () =>{
            const color = new Color({
                name: 'blue',
                green: 0,
                red: 0
        ...
        it.skip('has a required blue value above 0', () => {
            const color = new Color({
                name: 'blue',
                red: 0,
                green: 0,
        ...
        it.skip('has a required blue value under 256', () => {
            const color = new Color({
                name: 'blue',
                red: 0,
                green: 0,
    ...
    describe('green', () => {
        it.skip('has a required green value', () =>{
            const color = new Color({
                name: 'green',
                blue: 0,
                red: 0
        ...
        it.skip('has a required green value above 0', () => {
            const color = new Color({
                name: 'green',
                red: 0,
                blue: 0,
        ...
        it.skip('has a required green value under 256', () => {
            const color = new Color({
                name: 'green',
                red: 0,
                blue: 0,
